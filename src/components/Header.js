    ...
    return(
        ...
        <div className='tracking-wide sticky top-0 z-30 px-10 bg-dark-gray py-10 grid grid-cols-2 text-white'>
            ...
            <ul className='list-none flex flex-row justify-end space-x-5 font-sans'>
                <li><a className='hover:underline' href="../pages/Home.page.js">Home</a></li>
                <li><a className='hover:underline' href="../pages/Info.page.js">Info</a></li>
                <li><a className='hover:underline' href="../pages/Contact.page.js">Contact</a></li>
                <li>|</li>
